...
// --- BottomNav Component (Modified to use Link) ---
const BottomNav = () => {
    ...
    const getActiveTab = () => {
        ...
        // Add a check for profile to avoid highlighting any tab
        ...
        <Router>
            <Routes>
                ...
                >
                    ...
                    <Route path="profile/:userId" element={<ProfilePage />} /> {/* New route for profiles */}
